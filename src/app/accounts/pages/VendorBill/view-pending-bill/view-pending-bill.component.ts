...
export class ViewPendingBillComponent {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private vendorBillAccountService: VendorBillAccountService) {
